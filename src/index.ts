  ...
  tools: [
    {
      ...
      description:
        "Search the persistent knowledge base for solutions, patterns, gotchas, decisions, " +
      ...
      inputSchema: {
        ...
        properties: {
          ...
          project: {
            type: "string",
            description:
              "Project identifier override (auto-detected from git remote by default)",
          },
          limit: {
            type: "number",
    ...
    },
    {
      name: "add_knowledge",
      description:
        "Store a piece of knowledge for future sessions. Use this whenever you solve a " +
    ...
    },
    {
      ...
      description:
        "Get an annotated file tree of the project. Annotations show each file's role " +
    ...
    },
    {
      name: "annotate_file",
      description:
        "Attach a one-line role description to a file. These annotations appear in " +
      ...
      inputSchema: {
        ...
        properties: {
          ...
          role: {
            type: "string",
            description:
              "One-line description of what the file does and exports. " +
    ...
    },
    {
      name: "get_context",
      description:
        "Load accumulated context for the current project: recent session history and " +
    ...
    },
    {
      name: "log_session",
      description:
        "Record what happened in this session. Call before ending a session. " +
  ...
  try {
    switch (name) {
      case "search_knowledge":
        return await searchKnowledge(a as Parameters<typeof searchKnowledge>[0]);
      case "add_knowledge":
        return await addKnowledge(a as Parameters<typeof addKnowledge>[0]);
      case "get_project_map":
        return getProjectMap(a as Parameters<typeof getProjectMap>[0]);
      case "annotate_file":
        return annotateFile(a as Parameters<typeof annotateFile>[0]);
      case "get_context":
        return getContext(a as Parameters<typeof getContext>[0]);
      case "log_session":
        return logSession(a as Parameters<typeof logSession>[0]);
      default:
        return {
