...
const server = new Server(
  { name: "obsidian-tracker", version: "1.0.0" },
  { capabilities: { tools: {} } }
);
  ...
  tools: [
    {
      name: "log_session",
      description:
        "Log a Claude session to the Obsidian vault. Call this at the end of a session to record what was discussed, the output type, and key results.",
      inputSchema: {
        type: "object",
        properties: {
          area: {
